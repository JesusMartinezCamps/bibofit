             ...
             <div className="container mx-auto px-4 md:px-6">
                <div className="bg-gradient-to-r from-green-600 to-emerald-800 rounded-3xl p-8 md:p-16 text-center relative overflow-hidden">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 relative z-10">
                        ¿Listo para escalar tu negocio fitness?
                    </h2>
                    <p className="text-green-100 text-lg max-w-2xl mx-auto mb-10 relative z-10">
                        Únete a miles de entrenadores que ya han digitalizado su servicio con Bibofit.
                    </p>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
                        ...
                        <Link to="/pricing">
                            <Button variant="outline" size="lg" className="w-full sm:w-auto border-white text-white hover:bg-white/10 h-14 px-8 text-lg">
