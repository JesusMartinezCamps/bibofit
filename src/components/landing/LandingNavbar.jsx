            ...
            <div className="flex flex-col p-4 space-y-4">
              ...
              {!isHome && (
                <button
                  ...
                  className="text-left text-base font-medium text-gray-300 hover:text-green-400 py-2"
                >
                  Ir a Inicio
                </button>
              )}
              ...
              <div className="pt-2 border-t border-gray-700 flex flex-col gap-3">
                <Link to="/login" onClick={() => setIsMobileMenuOpen(false)}>
                  <Button variant="ghost" className="text-white bg-gray-500/10 hover:text-green-400 hover:bg-white/5">
                    Iniciar Sesión
                  </Button>
                </Link>
