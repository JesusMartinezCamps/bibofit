...
const RecipeView = ({
  ...
  return (
    <div className="text-white space-y-6 p-2 sm:p-4 md:p-6">
      ...
      <div className={cn(enableStickyMacros && "sticky top-0 z-30 bg-[#0C101D] -mx-2 px-2 sm:-mx-4 sm:px-4 md:-mx-6 md:px-6 py-2 shadow-xl border-b border-gray-800/60 mb-4")}>
      ...
      {actionButton && <div className="my-4">{actionButton}</div>}
