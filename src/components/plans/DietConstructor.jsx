...
const DietConstructor = ({ userId, dietPlan, onPlanUpdate, isTemplate }) => {
    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            if (dietPlan) {
                ...
                const { data: overrides, error: overridesError } = await supabase.from('diet_plan_calorie_overrides').select('*').eq('diet_plan_id', dietPlan.id).order('effective_date', { ascending: false });
    ...
    }, [macrosPct, dietPlan?.id, toast, loading]);
