      ...
      return (
        <Dialog open={open} onOpenChange={onOpenChange}>
          <DialogContent className="bg-[#1a1e23] border-gray-700 text-white sm:max-w-[425px]">
            <DialogHeader>
              <DialogTitle className="text-center text-2xl">Añadir Receta Libre</DialogTitle>
            ...
            <div className="grid gap-4 py-4">
              ...
              >
                ...
                <span className="text-lg font-semibold">Añadir Receta</span>
                <span className="text-sm text-gray-400">Crea una receta nueva</span>
              </button>
              <button
                onClick={onRepeat}
              ...
              >
                ...
                <span className="text-lg font-semibold">Repetir una Receta</span>
                <span className="text-sm text-gray-400">Elige una receta que ya hiciste</span>
              </button>
            </div>
          </DialogContent>
        </Dialog>
