...
const CalorieAdjustment = ({ 
    ...
    return (
        <div className="p-4 rounded-lg border border-gray-700 space-y-4 bg-slate-900/50">
            <h4 className="font-semibold text-lg text-white">Ajuste de Calorías Diarias</h4>
                ...
                <div className="p-4 rounded-lg space-y-4 bg-gray-800/30 border border-gray-700/50">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            />
                            <Button onClick={handleSaveManualCalories} size="sm" className="bg-green-600 hover:bg-green-700 text-white shrink-0">
