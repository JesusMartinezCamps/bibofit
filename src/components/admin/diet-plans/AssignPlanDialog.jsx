    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            {/* 
                ...
                - h-[60vh] on mobile (mobile fix)
                - sm:h-[85vh] on desktop
                - overflow-hidden on container
                - flex layout with scrollable middle section
            */}
                ...
                <div className="p-6 pt-4 border-t border-gray-700 bg-[#1a1e23] shrink-0">
                    <DialogFooter className="flex justify-between sm:justify-between w-full">
                        <Button 
                            ...
                            className="mt-2 hover:bg-gray-600/50 hover:text-gray-300 sm:mt-0"
                        >
