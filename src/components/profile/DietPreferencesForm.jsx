      ...
      <div className="space-y-8">
        ...
        <FormBlock title="Información General" icon={Info} color="green">
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
                <div className="md:col-span-3"><FormRow id="diet_goal" label="Objetivo de Dieta" type="text" value={formData.diet_goal || ''} onChange={handleChange} placeholder="Describe tu principal objetivo..." /></div>
                <div className="md:col-span-2 flex flex-col justify-end">
                    <Label htmlFor="diet_type_id" className="text-gray-300 mb-1.5">Tipo de Dieta</Label>
                    ...
                    <SelectTrigger id="diet_type_id"><SelectValue placeholder="Selecciona un tipo..." /></SelectTrigger>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                <FormRow id="lives_alone" label="¿Vives solo/a?" type="checkbox" value={formData.lives_alone} onChange={handleChange} color="green"/>
                <FormRow id="eats_out" label="¿Sueles comer fuera?" type="checkbox" value={formData.eats_out} onChange={handleChange} color="green"/>
                <FormRow id="likes_cooking" label="¿Te gusta cocinar?" type="checkbox" value={formData.likes_cooking} onChange={handleChange} color="green"/>
            </div>
        </FormBlock>
        ...
        headerContent={
            <div className="flex items-center gap-3 p-2 rounded bg-gray-800/50 border border-gray-700">
                ...
                <Select value={sensitivityLevel} onValueChange={setSensitivityLevel}>
                    <SelectTrigger className="h-8 w-32 bg-gray-700 border-gray-600 text-xs">
                        <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
