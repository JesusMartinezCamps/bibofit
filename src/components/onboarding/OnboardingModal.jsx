...
const OnboardingModal = ({ 
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center md:items-end md:justify-end bg-black/65 backdrop-blur-sm p-4 md:p-6">
      <motion.div 
        initial={{ opacity: 0, y: 40, x: 12, scale: 0.98 }}
