...
import { User, Shield, Calendar, BookOpen, StickyNote, ShoppingCart, LayoutList } from 'lucide-react'; // Added LayoutList for 'Mis Planes'
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <nav className="flex items-center space-x-1 bg-gray-800/50 p-1 rounded-lg">
                {isStaff && (
                  <>
                    <Button asChild variant="ghost" className={cn("text-gray-300 hover:bg-gray-700 hover:text-white h-auto py-1.5 px-3", location.pathname.includes('/content') && 'bg-gray-700 text-white')}>
                      <Link to={getContentLink()} className="relative flex items-center space-x-2">
