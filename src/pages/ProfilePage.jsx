...
import { User, Utensils, LogOut, ChevronRight, LineChart, CalendarCheck, RotateCcw, CalendarDays } from 'lucide-react'; 
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const ProfilePage = () => {
  ...
  const handleResetOnboarding = async () => {
      try {
          ...
          // Use window.location.href to force a clean reload and navigation to root
          // This avoids the React Router race conditions with reload()
          setTimeout(() => {
  ...
  const menuItems = [
    ...
    {
      label: 'Configurar mi nueva dieta', 
      href: '/dashboard',
      icon: CalendarDays,
      color: 'bg-gradient-to-r from-emerald-900 to-emerald-700 hover:from-emerald-700 hover:to-emerald-500',
    }   
  ];
      ...
      <main className="w-full px-4 py-8">
        ...
        >
          <div className="text-center mb-10">
            ...
            <Button 
                variant="link" 
                className="text-gray-500 hover:text-green-400 text-xs mt-2" 
