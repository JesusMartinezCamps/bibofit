...
import { User, Utensils, LogOut, ChevronRight, LineChart, CalendarCheck, LayoutGrid } from 'lucide-react'; // Added LayoutTemplate
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const ProfilePage = () => {
  ...
  const menuItems = [
    ...
    {
      label: 'Explorar Plantillas de Dieta', // New button
