...
import ShoppingListDialog from '@/components/shared/WeeklyDietPlanner/ShoppingListDialog';
            ...
            <main className="w-full px-4 py-8">
                ...
                >
                    <div className="flex justify-between items-center">
                      ...
                      <Button onClick={() => setShoppingListOpen(true)} className="bg-green-600 hover:bg-green-700">
