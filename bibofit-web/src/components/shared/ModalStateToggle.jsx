      ...
      return (
        <motion.div
          ...
          className={cn(
            ...
            isOptionTwoActive ? 'bg-cyan-800/30' : 'bg-muted/65',
            className
          )}
        >
          {fromHeader && (
            <Tooltip>
              <TooltipTrigger asChild>
                <Button
                  ...
                  className="h-8 w-8 rounded-full text-[#efffff] hover:text-foreground hover:bg-gray-200/20 absolute left-4 top-1/2 -translate-y-1/2"
                >
          ...
          <div className="flex-1 flex justify-center">
            <div className="flex items-center space-x-3">
              ...
              >
                <IconOne className={cn('h-5 w-5 transition-colors', !isOptionTwoActive ? 'text-white' : 'text-muted-foreground')} />
                <span className={cn('font-semibold transition-colors', !isOptionTwoActive ? 'text-white' : 'text-muted-foreground')}>{optionOne.label}</span>
              </div>
              <Switch
              ...
              >
                <IconTwo className={cn('h-5 w-5 transition-colors', isOptionTwoActive ? 'text-white' : 'text-muted-foreground')} />
                <span className={cn('font-semibold transition-colors', isOptionTwoActive ? 'text-white' : 'text-muted-foreground')}>{optionTwo.label}</span>
              </div>
            </div>
          </div>
        </motion.div>
