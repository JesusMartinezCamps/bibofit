            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="max-w-4xl mx-auto">
                    <Tabs defaultValue="coach" className="w-full">
                        <TabsList className="grid w-full grid-cols-2 bg-background border border-border p-1 mb-8">
                            <TabsTrigger value="client" className="data-[state=active]:bg-blue-500 data-[state=active]:text-white text-muted-foreground">Para Clientes</TabsTrigger>
                            <TabsTrigger value="coach" className="data-[state=active]:bg-green-500 data-[state=active]:text-black text-muted-foreground">Para Entrenadores</TabsTrigger>
                        </TabsList>
                        ...
                        <TabsContent value="coach" className="bg-background border border-border rounded-2xl p-8 animate-in fade-in-0 slide-in-from-left-4 duration-500">
                            <div className="grid md:grid-cols-2 gap-8 items-center">
                                ...
                                <div className="relative h-64 rounded-xl bg-muted overflow-hidden border border-border">
                        ...
                        <TabsContent value="client" className="bg-background border border-border rounded-2xl p-8 animate-in fade-in-0 slide-in-from-right-4 duration-500">
                             <div className="grid md:grid-cols-2 gap-8 items-center">
                                <div className="relative h-64 rounded-xl bg-muted overflow-hidden border border-border order-2 md:order-1">
