...
const ExerciseCard = ({ exercise, onSelect, isSelected }) => (
    <div 
      ...
      className={`flex items-center space-x-3 p-2 rounded-lg cursor-pointer transition-colors duration-200 ${isSelected ? 'bg-train-red/20' : 'hover:bg-muted'}`}
    >
                            ...
                            <Card className="bg-background border-border text-white h-full flex flex-col">
                                <CardHeader>
                                    ...
                                    <div className="relative mt-2">
                                        ...
                                        {searchTerm && <button type="button" onClick={() => setSearchTerm('')} className="absolute right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground"><X className="h-4 w-4" /></button>}
                                    </div>
                                </CardHeader>
                                <CardContent className="flex-grow overflow-hidden">
                                    <div className="h-full overflow-y-auto space-y-3 pr-2">
                                        ...
                                        ) : <p className="text-muted-foreground text-center pt-10">No se encontraron rutinas.</p>}
                                    </div>
                                </CardContent>
                            </Card>
                        </div>
                                ...
                                <CardContent>
                                    <form onSubmit={handleSubmit} className="space-y-6">
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="max-h-80 overflow-y-auto space-y-2 p-3 bg-card/80 rounded-md border border-border">
